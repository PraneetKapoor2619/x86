...
main proc
	...
	label1:
		...
		print str$(cnt)
		print chr$(13, 10, 0)
		print chr$("VALUE OF EBX: ")
		print uhex$(ebx)			;for printing a value in hexadecimal
		print chr$(13, 10, 0)		;for printing newline
		
		cmp ebx, var
		jnc label11
		print chr$("LESS ENCOUNTERED : var: ")
		print uhex$(var)
		print chr$(" ebx: ")
		print uhex$(ebx)
		print chr$(13, 10, 0)
		...
		print uhex$(var)
		print chr$(13, 10, 0)
		print chr$("And here we are!!", 13, 10, 0)
